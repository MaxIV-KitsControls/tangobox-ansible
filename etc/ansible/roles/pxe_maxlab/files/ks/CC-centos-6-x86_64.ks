...
url --url="http://192.168.150.10/centos/6/x86_64/img"
...
#repo --name=updates --baseurl=http://ftp.sunet.se/pub/Linux/distributions/centos/6/updates/x86_64
#repo --name=epel --baseurl=http://ftp.sunet.se/pub/Linux/distributions/fedora/epel/6/x86_64
...
logvol /     --vgname=vg0 --name=root --fstype="ext4" --size=50000
